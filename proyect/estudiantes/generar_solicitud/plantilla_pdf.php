...
<head>
    ...
    body {
        ...
        font-size: 11pt;
        line-height: 1.6;
        background-image: url('http://localhost/Proyecto_Instituto/GestionDocumental_02/xd/proyect/img/imagen_Practicas.jpg');
...
<table style="width: 100%; border-collapse: collapse; font-size: 11pt;" border="1">
    ...
    <tbody>
        <tr>
            <td style="white-space: pre-line;"><?= sanitize($_POST['nombre']) ?></td>
            <td><?= sanitize($_POST['cedula']) ?></td>
            <td style="white-space: pre-line;"><?= sanitize($_POST['carrera']) ?></td>
            <td><?= sanitize($_POST['nivel']) ?></td>
            <td><?= sanitize($_POST['contacto']) ?></td>
            <td><?= sanitize($_POST['correo']) ?></td>
            <td>&nbsp;</td>
        </tr>
    </tbody>
</table>
